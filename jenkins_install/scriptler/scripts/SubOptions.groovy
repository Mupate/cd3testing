...
List developer_services = ["<b>DEVELOPER SERVICES</b>:disabled","Upload current terraform files/state to Resource Manager", "Add/Modify/Delete OKE Cluster and Nodepools", "Add/Modify/Delete Alarms", "Add/Modify/Delete ServiceConnectors"]
